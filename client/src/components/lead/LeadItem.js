...
const LeadItem = ({auth, lead: {_id, companyName,clientName,finalStatus,clientEmail,clientPhoneNumber,clientAddress,pincode,salesPerson,date},fullContent}) => (
	<div>
      <li className="list-group-item">{companyName} - Created on <Moment format='DD/MM/YYYY'>{date}</Moment> </li>
      	  <li className='list-group-item'>Client Name : {clientName}</li>
      	  <li className='list-group-item'>Client Email : {clientEmail}</li>
      	  <li className='list-group-item'>Client Phone Number : {clientPhoneNumber}</li>
